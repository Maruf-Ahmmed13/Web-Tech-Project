        ...
        <div class="content-area">
            <div class="panel" style="max-width: 700px; margin: 0 auto;">
                <div class="panel-header" style="border-bottom: 1px solid #555; padding-bottom: 15px;">
                    ...
                    <span style="float: right; font-size: 14px; color: #aaa;"><?php echo $order['order_date']; ?></span>
                </div>
                ...
                <div style="margin-top: 30px; text-align: center;">
                    <a href="orders.php" class="btn btn-ghost" style="background-color: #DB7093; color: white; width: 100px; text-decoration: none; display: inline-block;">Close</a>
                </div>
            </div>
        </div>
    </div>
